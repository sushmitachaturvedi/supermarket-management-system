...
<div id="body">
	...
	<?php
	   ...
	   $empid=mysqli_fetch_array($empidset,MYSQLI_ASSOC);
        	...
        	<table>
                ...
                <tr><td style='padding:5px'>Last Name:</td>
					...
					<tr><td style='padding:5px'>Dept: </td>
						...
						$dept_set = mysqli_query($connect,"select distinct dept_name, dept_id from department");
				while($row = mysqli_fetch_array($dept_set,MYSQLI_ASSOC))
